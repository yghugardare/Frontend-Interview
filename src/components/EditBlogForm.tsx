...
export function EditBlogForm({ blog, open, onOpenChange, onSuccess }: EditBlogFormProps) {
            ...
            <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 mt-4">
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        ...
                        <Button
                            type="submit"
                            disabled={!isValid || updateBlog.isPending}
                        >
                    ...
                    {updateBlog.isError && (
                        <p className="text-sm text-destructive">
                            {updateBlog.error instanceof Error
                                ? updateBlog.error.message
