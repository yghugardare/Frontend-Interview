...
type ArticleCategory = 'FINANCE' | 'TECH' | 'BUSINESS' | 'ACCOUNTING' | 'INNOVATION';
...
const footerData: FooterSection[] = [
  ...
  return (
    <div className="main-container w-full ">
      {/* NAVBAR */}
      <div className="nav-bar w-full  flex justify-between h-24 px-4 py-2 items-center border-b-1 border-gray-400">
        {/* BRAND */}
      ...
      {/* BLOG COVER */}
      <div className="div blog-cover-section space-y-4 h-96 place-content-center px-8">
      ...
      <div className="blog-create w-full flex justify-end w-full px-8">
        <Button className='!p-6 text-lg font-semibold'onClick={()=>setOpen(true)}>
         <Plus/> Create Blog</Button>
      </div>

      {/* BLOG CONTAINER */}
      <div className="main-blog-container w-full grid grid-cols-12 gap-x-12 px-8">
        {/* BLOG POST LIST */}
        <div className="blog-post-list col-span-12 lg:col-span-4 space-y-8">
          {data?.map((el: ArticleType) => {
            return (
              <Card
                key={`blog-card-${el.id}`}
                className={` ${el.id === blogId ? "border-l-6  border-l-indigo-700" : ""}`}
              ...
              >
                ...
                <CardContent className="text-left space-y-2">
                  <div className="card-heading font-semibold text-2xl">
                    {el.category.join(" & ")}
                  </div>
                  <div className="card-desc text-xl text-gray-500 line-clamp-2">
                    {el.description}
                  </div>
                </CardContent>
                <CardFooter>
                  <div className="blog-category-tag bg-indigo-100 px-4 py-1 flex justify-center items-center rounded-full text-indigo-600 font-semibold">
                    Featured
                  </div>
                </CardFooter>
              </Card>
      ...
      <footer className="w-full h-96 bg-black">
        <div className="footer-content grid grid-cols-12 p-12 gap-x-12 text-white">
          <div className="brand-info col-span-3 space-y-4">
            {/* BRAND */}
            <div className="brand flex items-center gap-x-4">
          ...
          <div className="footer-link col-span-9 grid grid-cols-12 text-left">
        ...
        <div className="footer-base w-full flex justify-between items-center h-24 border-t-1 border-slate-400 text-gray-400 px-8">
